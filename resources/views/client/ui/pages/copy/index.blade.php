            ...
            <div class="row  ">
                ...
                <div class="col-md-3 p-0"> 
                  <div class="board-list ">
                    <h3 class="board-clr-1 d-flex align-items-center" > <img src="{{asset('assets/img/board-1.png')}}" class="img-fluid"/> Boarding Life <div class="clearfix"></div></h3>
                ...
                <div class="col-md-3 p-0"> 
                  <div class="board-list  ">
                    <h3 class="board-clr-2 d-flex align-items-center"> <img src="{{asset('assets/img/board-2.png')}}" class="img-fluid"/>   Academics <div class="clearfix"></div></h3>
                ...
                <div class="col-md-3 p-0"> 
                  <div class="board-list">
                    <h3 class="board-clr-3 d-flex align-items-center"> <img src="{{asset('assets/img/board-3.png')}}" class="img-fluid"/> Co-curricular <div class="clearfix"></div> </h3>
                ...
                <div class="col-md-3 p-0"> 
                  <div class="board-list">
                    <h3 class="board-clr-4 d-flex align-items-center"> <img src="{{asset('assets/img/board-4.png')}}" class="img-fluid"/>   Happiness Advantage <div class="clearfix"></div> </h3>
  ...
  <div class="container"> 
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <h4>We at Dehradun Hills Academy have served hundreds of happy families for the past 30+ years across India and <br/>
